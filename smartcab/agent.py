...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.trial = 0           # keeps track of the number of trials for epsilon decay
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = -((0.01 * self.trial) ** 10) + 1.0
            self.trial += 1
...
def run():
    ...
    sim = Simulator(env, display=True, update_delay=0.001, optimized=True)
